...
axis_fromrgb=delta(:,2:3).*[axis_fromrgb.*perceptuality, axis_fromrgb]; %P,Q component
axis_fromlab=delta(:,2:3).*[axis_fromlab.*perceptuality, axis_fromlab]; %P,Q component - Taekyu Shin #8
